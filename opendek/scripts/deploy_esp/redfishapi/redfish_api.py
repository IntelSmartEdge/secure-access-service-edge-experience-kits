...
class RedfishAPI:
    ...
    def set_next_onetime_boot_device_virtual_media(self):
        ...
        endpoint = "/Managers/iDRAC.Embedded.1/Actions/Oem/EID_674_Manager.ImportSystemConfiguration"
        ...
        while True:
            ...
            failed_msgs = ("failed", "completed with errors", "Not one", "not compliant", "Unable",
            ...
            if any((msg in message  for msg in failed_msgs)):
                logger.error("Job ID %s marked as %s but detected issue(s). "
